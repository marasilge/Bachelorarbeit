...
% Leerseite nach dem Inhaltsverzeichnis, damit die Einleitung auf Seite 3 beginnt.
\clearpage
...
The formalisation is the subject of \Cref{section:formalisation} and makes up the main part of this thesis. Based on short excerpts of the Lean code, we explain and assess the decisions made along the way. We formalise the results of \cref{section:math} up to the homotopy extension property for finite dimensional relative CW-complexes, but not the general case. \Cref{section:methodes} documents how AI was used for this project, and \Cref{section:conclusion} summarises what was achieved and indicates where the project could be continued.
